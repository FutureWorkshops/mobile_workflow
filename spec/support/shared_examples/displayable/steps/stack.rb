...
shared_examples_for 'stack' do |param|
  ...
  describe '#mw_display_button' do
    let(:result) do
      subject.mw_display_button(label: 'Sign Up', style: :outline, on_success: :forward, sf_symbol_name: 'Person',
  ...
  describe '#mw_display_system_url_button' do
    let(:result) do
      subject.mw_display_system_url_button(label: 'Open Link', apple_system_url: 'https://test.com/open',
  ...
  describe '#mw_display_link_button' do
    let(:result) do
      subject.mw_display_link_button(label: 'Log In', link_id: '9e5ad548-dd58-4f9b-adbe-99c59049398', style: :primary,
  ...
  describe '#mw_display_modal_workflow_button' do
    let(:result) do
      subject.mw_display_modal_workflow_button(label: 'Log In', modal_workflow_name: 'Log In', style: :primary,
                                               on_success: :none, sf_symbol_name: 'Login', material_icon_name: 'Login')
    end
